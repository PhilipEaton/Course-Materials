...
Since the Hamiltonian is off-diagonal, the eigenstates are superposition of the spin up and down states, $\left\vert\uparrow\right\rangle$ and $\left\vert\downarrow\right\rangle$, along the $z$-axis. We will see how to find these eigenstates in the next lecture. 
...
style="display:block; margin:1.5rem auto; max-width:400px; width:95%;">
